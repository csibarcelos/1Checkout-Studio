...
import { NavItemConfig } from './types'; // Adjusted path
import {
  ...
  Bars3Icon // For mobile menu in Header
} from '@heroicons/react/24/outline'; 

// Exporting Heroicons directly for convenience
...
export const Bars3IconHero = Bars3Icon; // Renamed to avoid conflict if any


// Custom SVG components (can be kept or replaced if Heroicons cover all needs)
...
export const ArchiveBoxXMarkIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const ListUnorderedIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12M8.25 17.25h12" />
...
// Updated App Logo Icon to use Imgur URL
...
export const NAV_ITEMS: NavItemConfig[] = [
  ...
  { name: 'Finanças', href: '/financas', icon: CreditCardIcon, soon: true },
  { name: 'Integrações', href: '/integracoes', icon: LinkIcon, soon: false },
  { name: 'Configurações', href: '/configuracoes', icon: CogIcon, soon: true },
];

export const NAV_ITEMS_SUPER_ADMIN: NavItemConfig[] = [
  { name: 'Dashboard Admin', href: '/superadmin/dashboard', icon: ShieldCheckIcon },
  { name: 'Config. Plataforma', href: '/superadmin/configuracoes-plataforma', icon: AdjustmentsHorizontalIcon },
  { name: 'Todos Usuários', href: '/superadmin/usuarios', icon: UserGroupIcon },
  { name: 'Todas Vendas', href: '/superadmin/vendas-gerais', icon: BanknotesIcon },
  { name: 'Log de Auditoria', href: '/superadmin/audit-log', icon: TableCellsIcon },
  { name: 'Todos os Produtos', href: '/superadmin/todos-produtos', icon: ChartPieIcon },
];


export const LOCALSTORAGE_KEYS = {
  AUTH_USER_TOKEN: 'plataformaCheckoutUserToken',
  PRODUCTS: 'plataformaCheckoutProducts',
  SALES: 'plataformaCheckoutSales',
  CUSTOMERS: 'plataformaCheckoutCustomers',
  ABANDONED_CARTS: 'plataformaCheckoutAbandonedCarts',
  PIX_TRANSACTIONS: 'plataformaCheckoutPixTransactions',
  USERS: 'plataformaCheckoutUsers',
  APP_SETTINGS: 'plataformaCheckoutAppSettings',
  PLATFORM_SETTINGS: 'plataformaCheckoutPlatformSettings',
  AUDIT_LOGS: 'plataformaCheckoutAuditLogs',
};
...
export const COLOR_PALETTE_OPTIONS = [
  { name: 'Amarelo (Padrão)', value: '#FDE047' }, // Theme primary
  { name: 'Verde (Secundário)', value: '#22C55E' }, // Theme secondary
  ...
  { name: 'Cinza Escuro', value: '#374151' }, // Good for dark accents
...
const cleanPhoneNumberForWhatsApp: (phoneNumber: string) => string = (phoneNumber: string): string => {
